...
<head>
    ...
    <link href="{{ asset('public/css/legacy/adminsidebar.css') }}" rel="stylesheet">
    <link href="{{ asset('public/css/legacy/adminpage.css') }}" rel="stylesheet">
    <link href="{{ asset('public/css/legacy/form-validation.css') }}" rel="stylesheet">
