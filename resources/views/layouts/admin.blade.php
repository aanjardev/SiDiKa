...
<head>
    ...
    <link href="{{ asset('css/legacy/adminsidebar.css') }}" rel="stylesheet">
    <link href="{{ asset('css/legacy/adminpage.css') }}" rel="stylesheet">
    <link href="{{ asset('css/legacy/form-validation.css') }}" rel="stylesheet">
