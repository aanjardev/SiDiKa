    ...
    <div class="card-body p-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" name="keterangan" rows="2" {{ isset($readOnly) && $readOnly ? 'readonly style=background-color:#f8f9fa;' : '' }}>{{ old('keterangan', $pelanggan->keterangan ?? '') }}</textarea>
            </div>
        </div>
