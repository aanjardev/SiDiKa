        ...
        <div class="col-lg-8 mb-4">
            <div class="card shadow-sm border-0" style="border-radius: 10px;">
                ...
                <div class="card-body p-4">
                    ...
                    {{-- Identitas Item --}}
                    <div class="mb-3">
                        <label class="form-label fw-medium text-secondary small">Nama Item</label>
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0 text-muted ps-3"><i class="fa-solid fa-tag"></i></span>
                            <input type="text" name="nama_item" class="form-control border-start-0 ps-2" value="{{ old('nama_item', $item->nama_item) }}" required>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-medium text-secondary small">Kategori</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0 text-muted ps-3"><i class="fa-solid fa-layer-group"></i></span>
                                <select name="kategori_id" class="form-select border-start-0 ps-2">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-medium text-secondary small">Kode SKU</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0 text-muted ps-3"><i class="fa-solid fa-barcode"></i></span>
                                <input type="text" name="kode_sku" class="form-control border-start-0 ps-2" value="{{ old('kode_sku', $item->kode_sku) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-0 mt-4">
                        <label class="form-label fw-medium text-secondary small">Deskripsi Produk (Final)</label>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card shadow-sm border-0 h-100" style="border-radius: 10px;">
                ...
                <div class="card-body p-4">
                    ...
                    {{-- Harga Jual --}}
                    <div class="mb-3">
                        <label class="form-label fw-medium text-secondary small">Rencana Harga Jual</label>
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0 text-muted ps-3">Rp</span>
                            <input type="text" name="harga_jual" id="harga_jual" class="form-control border-start-0 ps-2 rupiah-mask" value="{{ old('harga_jual', $item->harga_jual) }}">
                        </div>
                    </div>
