...
(function (window, document) {
    ...
    class TableAjax {
        ...
        bindForm() {
            ...
            if (this.searchInput) {
                const handler = defaultDebounce(() => this.fetch(this.buildUrl()), this.debounceMs);
        ...
        bindFilters() {
            this.filterSelectors.forEach((selector) => {
                ...
                if (!el) return;
                el.addEventListener('change', () => this.fetch(this.buildUrl()));
            });
        }

        bindPagination() {
            this.pagination.querySelectorAll('.pagination a').forEach((link) => {
        ...
        bindRowClick() {
            ...
            this.tableBody.addEventListener('click', (e) => {
                if (this.rowClick.ignoreSelector && e.target.closest(this.rowClick.ignoreSelector)) return;
